...
SKILLRACK
Filling Cans
Two cans are with capacity X and Y liters. The program must determine the number of steps required to obtain exactly Z litres of liquid in one of the cans. At the beginning both cans are empty. The following operations are counted as "steps".
emptying a vessel,
filling a vessel,
...
// i solve this question without useing bfs but this is a bfs question 

import java.util.*;

public class skillrack_23 {
